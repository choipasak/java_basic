...
public class StringMethod {
	...
	public static void main(String[] args) {
		...
		char c = str.charAt(4);//인덱스 4번을 반환
		...
		//length(): 문자열의 총 길이 반환.
		int len = str.length(); //배열의 length가 아님. 얘는 문자열 메서드임
		...
		int idx2 = str.lastIndexOf("l"); // 이건 뒤부터 탐색
		System.out.println("idx2: " + idx2);
		
		//여러 문자(한 단어)를 전달하면 시작 인덱스를 알려줍니다.
		...
		int i = Integer.parseInt(s1); //문자열을 정수
		double d = Double.parseDouble(s2); //문자열을 실수
