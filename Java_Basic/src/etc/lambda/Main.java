...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // 100g 이하인 사과를 필터링 해보자!
//        FilterApple을 import static으로 바꿔서 사용했다!
        List<Apple> apples1 = filterApple(appleBasket, new LightApplePredicate());
        for (Apple apple : apples1) {
            System.out.println(apple);
        }

        // 빨강 또는 노랑 사과만 필터링 해보자!
        // 위에 있는 메서드는 색상을 1개만 받는 메서드임
        // 그럼 새로운 메서드를 생성해야 하는가 -> X
        // 클래스를 만드는 건 재활용성을 위해서임.
        // 지금은 한번 쓰고 말거니까 익명 함수를 사용 해 준다.
        // 작성할 익명 클래스 선언을 더 쉽게 작성하게 만들어 주는 것이 '람다'
        ...
        System.out.println("============= 숫자에서 제곱 수를 매핑 =============");
