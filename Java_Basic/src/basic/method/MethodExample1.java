...
public class MethodExample1 {
	...
	//메서드 선언! (static은 뒤에서 알려드릴게요. 지금은 없다고 생각하세요.)
	...
	public static void main(String[] args) {
		...
		// 리턴값을 변수에 새로 선언해서 대입하고 저장할 수 있다.
		System.out.println(total);
		
		System.out.println("1~100까지의 누적합계: " + calcTotal(100));
		System.out.println("1~200까지의 누적합계: " + calcTotal(200));
		System.out.println("1~300까지의 누적합계: " + calcTotal(300));
		System.out.println("1~400까지의 누적합계: " + calcTotal(400));
		System.out.println("1~500까지의 누적합계: " + calcTotal(500));
		System.out.println("1~600까지의 누적합계: " + calcTotal(600));
		System.out.println("1~700까지의 누적합계: " + calcTotal(700));
