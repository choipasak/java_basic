...
public class MethodExample3 {
	...
	// return은 한번밖에 안되는데 여러개의 사칙연산을 한번에 보내고 싶을 때!
	static int[] operateTotal(int n1, int n2){
		// return이 발동되면 호출한 곳으로 값을 반환하는 동시에 함수를 강제 종료함.
	...
	static void divide(int n1, int n2) {
		if(n2 == 0) {
			...
			return; //값이 없는 return; -> 이렇게 주면 강제 종료로 사용가능. 
			//break;는 loop나 switch에서만 사용 가능하다.
		}
		int result = n1/n2;
	...
	public static void main(String[] args) {
        ...
        */
		...
		int[] res = {57, 89, 78, 91, 93, 47};
		double[] result = calcArrayTotal(res);
        ...
        */
		/*
		int r4 = multi(10, 7);
		//이건 void메서드이기 때문에 변수안에 담을 수 없다.
		
		System.out.println(multi(10, 7));
		이것도 안됨
		*/
		multi(add(2, 8), add(3, 7)); //add는 리턴값이 있어서 가능
		//위의 식을 반대로하면 error.
